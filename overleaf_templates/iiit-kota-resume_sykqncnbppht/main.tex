...
\parbox{2.35cm}{%
\includegraphics[width=2cm,clip]{IIITK_logo.png}
}
...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  {Indian Institute Of Information Technology, Kota} & \href{https://www.yourLinkedinProfile.com/in/}{\raisebox{0.0\height}{\footnotesize \faLinkedin}\ {LinkedIn Profile}}
\end{tabularx}
}
% \parbox{3.0cm}{%
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Indian Institute of Information Technology, Kota}{CGPA/Percentage: xxx}
