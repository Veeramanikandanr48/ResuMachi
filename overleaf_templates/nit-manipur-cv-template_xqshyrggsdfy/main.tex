...
\newcommand{\emailb}{officialemail@nitmanipur.ac.in} %Email 2
...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  {National Institute Of Technology, Manipur} & \href{https://www.yourLinkedinProfile.com/in/}{\raisebox{0.0\height}{\footnotesize \faLinkedin}\ {LinkedIn Profile}}
\end{tabularx}
}
% \parbox{3.0cm}{%
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {National Institute of Technology, Manipur}{CGPA/Percentage: xxx}
