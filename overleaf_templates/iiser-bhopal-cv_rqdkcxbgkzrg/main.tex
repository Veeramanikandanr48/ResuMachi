...
\newcommand{\course}{Bs-Ms - XXXXXXX and YYYYYYY Engineering} % Your Course
...
\includegraphics[width=2cm,clip]{iiserb_logo.jpg}
...
\begin{tabularx}{\linewidth}{L r}
  ...
  {Minor in Humanities and social sicences} &  \href{https://github.com/\github}{Github} $|$ \href{\website}{Website}\\
  {Indian Institute of Science Education and Research, Bhopal} & \href{https://www.linkedin.com/in/\linkedin/}{linkedin.com/in/\linkedin}
\end{tabularx}
}
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|}
  ...
  \hline
  B.S. Major & Indian Institute of Science Education and Research, Bhopal & 0.00 & 2016-Present\\
  \hline
  %B.Tech. Minor & Indian Institute of Science Education and Research, Bhopal & 0.0 & 2017-Present\\ %Optional
  %\hline
...
\resumePOR{Secretary} % Position
    {XYZ Club, IISER Bhopal} %Club,Event
