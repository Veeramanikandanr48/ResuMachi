...
\includegraphics[width=2.5cm,clip]{Narula_Institute_of_Technology_logo.png}
% replace the fields with your details

}\parbox{\dimexpr\linewidth-3.1cm\relax}{
\begin{tabularx}{\linewidth}{L r} 
  \textbf{\LARGE Tamal Barman} & +91-1234567890\\ 
  \course &  \href{mailto:example@lol.com}{example@lol.com}\\
  \department &  \href{https://github.com/\github}{Github} \\
  {Narula Institute of Technology, Kolkata} & \href{https://www.linkedin.com/in}{linkedin.com/in/} 
    \end{tabularx}
}
...
\resumePOR{Coordinator/Volunteer/Member} % Position
    {XYZ Club, Narula Institute of Technology} %Club,Event
