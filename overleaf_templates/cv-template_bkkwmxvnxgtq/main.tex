...
\listitem[] Coursework -- Relevant course 1, Relevant course 2, Relevant course 3...
...
% \begin{cvsection}{Custom}

% \begin{cvsubsection}
% {Custom Subheader} {Custom Date}
% {Custom Sub-subheader} {Custom Location}

% \listitem[] Custom Info
