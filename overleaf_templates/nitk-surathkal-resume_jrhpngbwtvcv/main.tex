...
\includegraphics[width=2cm,clip]{nitk.png}
...
\begin{tabularx}{\linewidth}{L r}
  ...
  {National Institute Of Technology Karnataka, Surathkal} & \href{https://www.linkedin.com/in/\linkedin/}{\linkedin}
\end{tabularx}
}
...
%     \resumeSubheading
%       {National Institute of Technology Karnataka}{Manglore, India}
%       {Bachelor of Technology in Computer Science and Engineering ;  GPA: 7.55}{November. 2020 -- April. 2024 (Expected)}
%     \resumeSubheading
%       {Jawahar Navodaya Vidyalaya}{Bangalore, Karnataka}
%       {Central Board of Secondary Education (Class XII);  Percentage: 96.60}{March. 2020}
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|}
  ...
  \hline
  B.Tech. Minor & National Institute Of Technology Karnataka, Surathkal & 0.0 (Current) & 20XX-Present\\ %Optional
  \hline
...
\resumeSubHeadingListStart
    ...
    % \resumeProject
    %   {Project Name 2}
    %   {XYZ event, NIT , dashpur}{Dec. 20XX - Jan. 20XX}{\href{Links to Reports}{Reports}}
    %   \resumeItemListStart
    % \item {Work Done 1}
    %     \item {Work Done 2}
    % \resumeItemListEnd
...
\resumeHeadingSkillStart
 \resumeSubItem{Computer Science} % Category
    {Operating System, Database Management, Data Structure ans algorithm, Computer Networks \& Machine Learning }
...
\resumePOR{Secretary} % Position
    {XYZ Club, NITK Surathkal} %Club,Event
    {Apr. 20XX - Apr. 20XX} %Tenure Period
\resumeSubHeadingListEnd
\vspace{-4mm}
