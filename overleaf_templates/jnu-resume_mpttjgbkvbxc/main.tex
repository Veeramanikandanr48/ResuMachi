...
\newcommand{\emailb}{officialemail@jnu.ac.in} %Email 2
...
\parbox{1.8cm}{%
\includegraphics[width=1.6cm,height=2.1cm,clip]{jnu.png}
}
...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  {Jawaharlal Nehru University, New Delhi} & \href{https://www.yourLinkedinProfile.com/in/}{\raisebox{0.0\height}{\footnotesize \faLinkedin}\ {LinkedIn Profile}}
\end{tabularx}
}
% \parbox{3.0cm}{%
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Jawaharlal Nehru University, New Delhi}{CGPA/Percentage: xxx}
