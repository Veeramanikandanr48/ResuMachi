...
\newcommand{\course}{B.E. - XXXXXXX and YYYYYYY Engineering} % Your Course
...
\includegraphics[width=2cm,clip]{mbm_logo1.jpg}
...
\begin{tabularx}{\linewidth}{L r}
  ...
  {MBM University, Jodhpur} &  \href{https://github.com/\github}{Github} $|$ \href{\website}{Website}\\
  \href{https://www.leetcode.com/in}{leetcode.com/in/USERID} & \href{https://www.linkedin.com/in/\linkedin/}{linkedin.com/in/\linkedin}
\end{tabularx}
}
...
{\dimexpr\textwidth-3mm\relax}{|c|C|c|c|}
  ...
  \hline
  B.E.  & MBM University Jodhpur & 0.0r0 (Current) & 2021-Present\\
  \hline
  Senior Secondary & CBSE Board & 00.0\% & 2021 \\
  \hline
  Secondary & CBSE Board & 00.0\% & 2019 \\
  \hline
\end{tabularx}}
\vspace{-2mm}
 ...
 \section{Experience}
   \resumeSubHeadingListStart
     ...
     \resumeSubheading
       ...
       {XXXXXXXXXXX \& YYYYYYYYYYYY Intern}{May 2023 - Jul. 2023}
       \resumeItemListStart
     ...
     \resumeItemListEnd
      ...
      \resumeSubheading
        ...
        {API Developer \& Machine Learning Intern}{May. 2022 - Jul. 2022}
        \resumeItemListStart
...
\resumePOR{Coordinator/Volunteer/Member} % Position
    {XYZ Club, MBM University} %Club,Event
...
\resumePOR{Bronze Medal} % Award
    { XYZ Challenge, ABC Company, Jaipur} % Event
    {2023} %Event Year
\resumePOR{SIH} % Award
    { Secured \textbf{2nd rank} among 15 teams} % Event
    {2023} %Event Year
\resumePOR{Encarta } % Award
    {secured \textbf{2nd rank} in ML competition} %Event
    {2022} %Event Year
